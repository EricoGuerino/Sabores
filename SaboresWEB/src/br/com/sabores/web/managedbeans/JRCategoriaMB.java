...
public class JRCategoriaMB {
    ...
    public void setListOfUser(List<Categoria> categorias) {
        this.categorias = categorias;
    }
    JasperPrint jasperPrint;
    public void init() throws JRException{
        JRBeanCollectionDataSource beanCollectionDataSource=new JRBeanCollectionDataSource(this.categorias);
        jasperPrint=JasperFillManager.fillReport("C:\\Users\\erico.felicio\\Documents\\workspaces\\workspace_outros_wildfly\\Sabores\\SaboresWEB\\WebContent\\pages\\protected\\admin\\tabelasDeDados\\relatorios\\report.jasper", new HashMap(), beanCollectionDataSource);
    }
